 ...
 * @brief   Arduino wolfSSL library custom user settings header for ESP32-S3
 * @author  golden-guy <s.berger81[at]gmail.com>
 ******************************************************************************/
...
#undef NO_SHA256
    ...
    /* keep all data in registers and partially unroll loops */
